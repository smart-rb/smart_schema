...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/smart-rb/smart_schema'
  spec.metadata['changelog_uri'] = 'https://github.com/smart-rb/smart_schema/blob/master/CHANGELOG.md'
